...
$path_pages = "../pages/";
$title = 'Profiilisivu';
$css = 'profiilisivu.css';
$path = "../components/";include "../components/header.php";
?>
<div class="container">
    <!-- Kuva ja perustiedot -->
    <img src="https://cdn.pixabay.com/photo/2019/07/02/03/10/highland-cattle-4311375_1280.jpg" alt="Profiilikuva"
        class="profile-image">
